...
3. Local Dependency  설치
   ...
   9. https://localhost:4000/ 화면에 Hello React Skeleton 출력
   ...
   10. 현재 상태는 서버 실행 중 코드가 변경되면 모든 페이지가 새로고침 된다.
      ...
      3. src/index.js
         ...
         ERROR in multi (webpack)-dev-server/client?https://0.0.0.0:4000 webpack/hot/dev-server ./src/index.js

         Module not found: Error: Can't resolve 'react-hot-loader/webpack' in '/Users/Duck/Project/inflearn_react'

          @ multi (webpack)-dev-server/client?https://0.0.0.0:4000 webpack/hot/dev-server ./src/index.js
