...
마크 다운으로 블로그 정리를 하는 분들과 나 자신을 위해 기능별로 사용하는 문법들을 정리해 보았습니다. 코드는 동일하지만 이 포스팅에서 보이는 것들은 제 블로그 테마에 입혀진 CSS에 의해 기본 마크 다운 효과와 다르게 보이는 것도 있으니 이 점 착오없으시길 바랍니다. 또한 유용한 HTML태그들도 같이 보여드립니다. \<>태그 안에 감싸져 있는 것들은 모두 html태그 입니다.
...
![Smithsonian Image](/img/2017-07-07-01.jpg){: .left}
![Smithsonian Image](/img/2017-07-07-01.jpg){: .right}
