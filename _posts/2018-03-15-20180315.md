...
* 필요한 준비물 : yarn(https://yarnpkg.com/lang/en/), 에디터
  ...
  14. query 파라미터를 처리하는 방법
      ...
      * https://localhost:3000/search?keyword=asd 와 같은 URL 요청이 들어오면 location에는 ?keyword=asd 라는 값이 저장된다. 여기서 이 location 값을 parsing하는 원리.
